...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const baseStyles = "flex items-center justify-center px-5 py-2.5 rounded-xl font-bold transition-all active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-slate-900 disabled:opacity-50 disabled:cursor-not-allowed";
  
  const variants = {
    primary: "bg-gradient-to-r from-cyan-600 via-blue-600 to-purple-600 text-white hover:opacity-90 focus:ring-blue-500 shadow-xl shadow-blue-500/20",
